...
def main():
    ...
    BASICFONT = pygame.font.Font('./fonts/Roboto-Bold.ttf', BASICFONTSIZE)

    # store the option buttons and their rectangles in OPTIONS
    UNDO_SURF, UNDO_RECT = makeText('Undo Move', TEXTCOLOR, TILECOLOR, WINDOWWIDTH - 120, WINDOWHEIGHT - 120)
    ...
    mainBoard, solutionSeq = generateNewPuzzle(RANDOMMOVES)
    ...
    while True: # main game loop
        ...
        msg = 'Click tile to slide.' # contains the message to show in the upper left
